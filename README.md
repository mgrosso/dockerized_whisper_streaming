...
**whisper-streamer Docker Build System Dependencies**

-   docker

**Audio Streaming System Dependencies**
...
Launch a docker container with a tiny.en transcription model running as a streaming server

```bash
docker compose up
```

From a local computer with ffmpeg and netcat installed, stream audio to the whisper server
